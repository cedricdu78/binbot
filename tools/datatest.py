...
def simulator(available, config_mise, config_median, config_prc, config_profit, config_stoploss, depot, startDate):
    orders = {}
    nbSell = 0
    nbLoss = 0
    ...
    for timestamp, datas in datasource.items():
        ...
        if date_now.hour == 23 and date_now.minute == 45:
            #print(str(date_now) + ' ' + str([config_mise, config_median, config_prc, config_profit, config_stoploss, str(startDate)]) + ' capital: ' + str(capital) + '/' + str(int(investissement)) + ' max_capital: ' + str(max_capital) + ' available: ' + str(available) + ' nbOrder: ' + str(len(orders)) + ' nbSell: ' + str(nbSellDaily) + ' nbLoss: ' + str(nbLossDaily) + ' Dead: ' + str(len(symbol_dead)))
    ...
    print(str(date_now) + ' ' + str([config_mise, config_median, config_prc, config_profit, config_stoploss, str(startDate)]) + ' capital: ' + str(capital) + '/' + str(int(investissement)) + ' max_capital: ' + str(max_capital) + ' available: ' + str(available) + ' nbOrder: ' + str(len(orders)) + ' nbSell: ' + str(nbSell) + ' nbLoss: ' + str(nbLoss) + ' Dead: ' + str(len(symbol_dead)))
...
simulator(2000, 4, [-10, 40], 10, 15, 1, 1000, datetime.strptime('01-01-2021', "%d-%m-%Y"))
simulator(2000, 4, [-10, 40], 10, 15, 1, 0, datetime.strptime('01-01-2021', "%d-%m-%Y"))
simulator(2000, 4, [-10, 40], 10, 15, 1, 1000, datetime.strptime('01-01-2024', "%d-%m-%Y"))
simulator(2000, 4, [-10, 40], 10, 15, 1, 0, datetime.strptime('01-01-2024', "%d-%m-%Y"))
