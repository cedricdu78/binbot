            ...
            for (const [, value] of Object.entries(tickers)) {
                ...
                if (Number(balances[value.name].onOrder) === 0
                    ...
                    if (moy * (100 - b_median) / 100 <= value.price &&
                        ...
                        lenVol = lenVol.length > 1 ? (lenVol[1].split('1')[0] + '1').length : 0
                        ...
                        lenPrice = lenPrice.length > 1 ? (lenPrice[1].split('1')[0] + '1').length : 0
                        ...
                        await binance.marketBuy(value.symbol, volume, (error,) => {
                            if (error !== null) {
                                ...
                                console.log(value.symbol + " [" + responseJson.code + "]: " + responseJson["msg"] + " " + price + " " + volume)
                            } else {
