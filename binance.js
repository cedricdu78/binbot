    ...
    while (1) {
        ...
        try {
            ...
            new Promise(function(resolve, reject) {
                ...
                new Promise(function(resolve, reject) {
                    binance.openOrders(undefined,(error, open_orders) => {
                        if (error !== null)
                            reject(Error(error));
                        else resolve(open_orders);
                    })
                    ...
                    new Promise(function(resolve, reject) {
                        binance.exchangeInfo((error, exchangeInfo) => {
                            if (error !== null)
                                reject(Error(error));
                            else resolve(Object.entries(exchangeInfo['symbols']).filter(([, value]) =>
                                ...
                                new Promise(function (resolve,) {
                                    if (open_orders.length > 0) {
                                        ...
                                        Object.entries(open_orders).forEach(function([, _order]) {
                                            let value = currencies.filter(([, val]) => val.symbol === _order.symbol)[0][1]
